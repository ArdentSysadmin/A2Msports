...
abstract class BaseFacebook
{
  ...
  public function getLoginUrl($params=array()) {
    ...
    //$currentUrl = "http://a2msports.com/login/validate_login/";
		$currentUrl = base_url()."login/validate_login";
	  if(isset($params['redirect']) and $params['redirect'] != '')
		  $currentUrl = $params['redirect'];
  ...
  protected function getAccessTokenFromCode($code, $redirect_uri = null) {
    ...
    //parse_str($access_token_response, $response_params);
	//echo "<pre>"; print_r($response_params);
	//echo $response_params->access_token;
