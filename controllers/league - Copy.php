<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	public function create_trnmt()
	{
		...
		//echo "<pre>"; print_r($_POST); exit;
			...
			$details_rules_pdf_folder = 'C:\inetpub\wwwroot\a2msports\tour_pictures\\'.$tourn_id;
			...
			foreach ($tourn_events_limit as $event => $limit) {
				...
				if($limit!=="" || $limit!=NULL){
				 	...
				 	if($users_cnt[$event] >= $limit){
                        ...
                        $limits[$evnt]="<span style='color:red;'>You will be in waitlist: ".$waitlist."</span>";
				 	}else{
...
print_r($mult_events);*/
		...
		public function viewtournament($tid, $stat = '')
		{
			if(!is_numeric($tid)){ echo "Invalid Request!"; exit; }
