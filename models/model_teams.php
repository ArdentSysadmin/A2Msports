<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	/*	public function get_TeamsByCountry($country,$sport){
			$qry_check = $this->db->query("SELECT u.Users_ID,u.Firstname,u.Lastname,t.Team_name,t.Captain,t.Players,h.hcl_city,h.hcl_state,t.Team_ID FROM Users u JOIN Teams t ON u.Users_ID = t.Created_by AND t.Sport = '".$sport."' JOIN Home_Court_Locations h ON t.Home_loc_id = h.hcl_id AND h.hcl_country = '".$country."'");
