<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class model_league extends CI_Model {
		...
		public function get_reg_tourn_event_players($tourn_id, $types){
			$reg_status = "WithDrawn";
			$like_qry	= "";
			...
			$qry_check = $this->db->query("SELECT * FROM RegisterTournament WHERE Tournament_ID = $tourn_id AND (Reg_Status != '$reg_status' OR Reg_Status IS NULL) AND {$like_qry}");
			//echo $this->db->last_query();
			return $qry_check->result();
		}
