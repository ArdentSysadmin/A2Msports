...
//exit;
		...
		public function addNewGenMatch1($data){
		...
		public function addNewGenMatch2($data, $data2)
		{
			...
			if($data['Player1_Partner'])
			$player1_partner = $data['Player1_Partner'];

			$opp_user		= $data2['Opponent'];

			if($data2['Player2_Partner'])
			$opp_user_partner	= $data2['Player2_Partner'];

			$p1_score	= $data2['Player1_Score'];
			$p2_score	= $data2['Opponent_Score'];
		...
		$eval_player_scores = $this->calc_player_scores($p1_score_post, $p2_score_post);
//echo "<pre>"; print_r($eval_player_scores); exit;
			$player1_score		 = $eval_player_scores['Player1_Score'];
			$player2_score		 = $eval_player_scores['Player2_Score'];
			$player1_score_total = $eval_player_scores['Player1_Tot'];
			$player2_score_total = $eval_player_scores['Player2_Tot'];
		...
		$played_date = $match_date;
			...
			$data2['Winner'] = $winner;
			$data2['Player1_Win_Percent'] = number_format((float) $win_per_p1, 2);
			$data2['Player2_Win_Percent'] = number_format((float) $win_per_p2, 2);
			$data2['Player1_Score']	= $player1_score;
			$data2['Opponent_Score'] = $player2_score;

			$result = $this->db->insert('IndividualPlay', $data2); 
/*echo "<pre>";
print_r($data2);
echo $this->db->last_query();
exit;*/
