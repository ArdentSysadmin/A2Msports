...
?>
<li id="show_more"><a href="<?php echo base_url(); ?>sports"><span align='center'>More Sports&nbsp;&nbsp;<!-- <i class="fa fa-chevron-down"></i> --></span></a></li>
<?//=$rest_menu;?>
 </ul>
</li>
...
<b>Amateurs to Masters (A2M) Sports is the best sports platform for Academies, Clubs, Coaches and Players. A Free, Online tool for anyone to create and print Free Brackets, find clubs and players in the area and book courts/ tables for Pay and Play. Anyone can also organize Tournaments or Leagues including Team Leagues and Challenge Ladders.</b>
</p>
<p>
<b>For clubs, we offer a custom website and a branded mobile app with all the features they need to run their club. OUr platform comes with Tournament/ League Software, Club Ratings for Players, Membership Mangement, Pay n Play (Club Reservations) and more! We do all this for nominal fee and you got to see it to believe it! </b>
</p>
...
<div align="center"> 
	<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" style="background-color: #81a32b; border-color:#ff8a00">
  Watch Intro >>
</button>
