...
<input name="coach_page" class="coach_page" type="hidden" value="1" />
...
<div class='col-md-6'>
<label for='id_accomodation'>Sport You Coach</label>
<select id='coach_sport' name="coach_sport" class='form-control' style="width:30%">
<option value="">Select</option>
...
<label for="Sportsintrests">* Other Sports Interested in:</label><div class="clear"></div>
<?php foreach($intrests as $row) { ?> 
<input type="checkbox" class="sport_class" style="margin-bottom:15px;" name="Sportsintrests[]" value="<?php echo $row->SportsType_ID;?>"> <?php echo $row->Sportname;?> &nbsp;&nbsp;
<?php } ?>
</div>

<!-- <div class="col-md-12" style="margin-bottom: 25px;">
<label for="Sportsintrests">Other Sports Interested in:</label><div class="clear"></div>
	<div class="col-md-2 col-xs-6" style="width:14%">
	<input type="checkbox" class="sport_class" class="sport_class" name="Sportsintrests[]" value="1">&nbsp;Tennis<br>
	...
	<input type="checkbox" class="sport_class" name="Sportsintrests[]" value="17">&nbsp;General Fitness<br>	</div>
...
<textarea id='coach_profile' name="coach_profile" class='form-control ui-autocomplete-input col-md-12' rows="10" placeholder="Write Your Accomplishments Here"></textarea>
</div> -->

<div class="col-md-12">
<label for="email">Coach's Website</label><div class="clear"></div>
<input id='coach_website' name="coach_website" class='form-control ui-autocomplete-input col-md-12' type="text" placeholder="Website Name"  style="width:45%" />
</div>
