...
if(($tour_details->Usersid == $users_id or $tour_details->Tournament_Director == $users_id or $this->is_super_admin) and $this->logged_user) {    /// tournament admin access links
	$logged_user_role = 'Admin';
}
else if($is_logged_user_reg and $this->logged_user) {
...
<div class="col-md-6">
<div style="font-size:25px; color:#ff8a00; font-weight:bold; padding-bottom:20px; line-height:30px"><?php echo $tour_details->tournament_title; ?>
...
<b>Status: </b>
<?php
if($tour_details->Is_Publish) { echo "<span style='color:green;font-weight:bold;font-size: 20;'>Published</span>"; }
else{ echo "<span style='color:red;font-weight:bold;font-size: 20;'>UnPublished</span>"; }
}
?>
</div>
</div><!--Close col-md-6-->
...
<?php
if(($tour_details->Usersid == $users_id or $tour_details->Tournament_Director == $users_id or $this->is_super_admin) and $cdate <= $exp_date) {   /// tournament admin access links
?>
...
<?php $this->load->view('tournament/view_tournament_summary', $data); ?>
</div>
