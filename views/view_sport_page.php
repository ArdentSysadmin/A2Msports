...
?>" style="object-fit: cover; filter: blur(6px); position: relative; height: 242px;" />
         ...
         <div class="row banner_pagetwo_two">
           <div class="col-lg-8 pb-4">
             <div class="banner_two_content pl-30 pt-4 mx-3">
               ...
               <a href="<?=base_url()."login";?>" class="btn_orange">Become a A2M Club Member</a>
             </div>
           </div>
         ...
         <div class="row">
		   ...
		   $a =1;
            ...
            <div class="col-lg-4">
              <div class="galler_img">
                <img src="<?php echo $image_pic; ?>" class="w-100">
              </div>
            </div>
			<?php
				break;
		   ...
		   $a =1;
				...
				if(($a > 1 and $a <= 5) and file_exists($image_loc)){
					?>
                <div class="col-6">
                  <img src="<?php echo $image_pic; ?>" class="w-100 mb-3">
                </div>
			<?php
				}
					$a++;
