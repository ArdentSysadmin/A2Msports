...
else if($tour_details->SportsType == 11){ $tourn_img = "fencing_land_bg.jpg"; }
else if($tour_details->SportsType == 12){ $tourn_img = "bowling_land_bg.jpg"; }
...
switch ($tour_details->SportsType) {
    ...
    case 6:
        ...
        break;
    case 7:
        $sport_img="images/default_pickleball.jpg";
        break;
    case 8:
        $sport_img="images/player-focus.jpg";
        break;
...
<div style="text-align:center; padding:10px 0px; background:#81a32b;">
<span style="font-weight:bold; color:#fff; font-family: 'Acme', sans-serif !important; font-size:28px"><?=$tour_details->tournament_title;?></span></div>
                     ...
                     <div class="col-md-12 homevideo">
                      ...
                      <div class="video-txt">
                        ...
                        <p style="color:#fff"><span>A2MScore:</span>
                          ...
                          echo max($getA2MScore['A2MScore'],$getA2MScore['A2MScore_Doubles'],$getA2MScore['A2MScore_Mixed']);
                          ?>
                          <br>
        ...
        <div class="leaghead"><h2 style="padding-bottom:20px" id="draws">Draws</h2></div>
         <div class="container">
              ...
              <tr>
                ...
                <th class='text-left'>3rd Place</th>
                <th class='text-left'>4th Place</th>
              </tr>
              <?php
              ...
              <td align='left'><?php 
                 ...
                 if($winner == $line_matches['Player1']){
				  ...
				  else if($winner == $line_matches['Player2']){
...
<!-- 
 ...
 -->          
  <td align='left'><?php 
                  $line_matches = league::get_tourn_final_line_matches($bk->BracketID, '-1');
	...
	for($i=0; $i<count(array_filter($p2)); $i++){
		$p2_sum = intval($p2_sum) + intval($p2[$i]);
					  ...
					  if(!array_key_exists($cur_player1, $players)){			//	Player1 
						...
						//$win_per = ($p1_sum / ($p1_sum + $p2_sum)) * 100;
						//$players[$cur_player1]['winper'] = number_format($win_per, 2);
					  }
					  else{
						...
						$players[$cur_player1]['win_per']  += $p1_sum;
						//$win_per = (($players[$cur_player1]['score']+$p1_sum) / (($players[$cur_player1]['score']+$p1_sum) + ($players[$cur_player2]['score']+$p2_sum))) * 100;
						//$players[$cur_player1]['winper'] = number_format($win_per, 2);
					  }
					  ...
					  if(!array_key_exists($cur_player2, $players)){			//	Player2 
						...
						//$win_per2 = ($p2_sum / ($p1_sum + $p2_sum)) * 100;
						//$players[$cur_player2]['winper'] = number_format($win_per2, 2);
					  }
					  else{
						...
						$players[$cur_player2]['win_per']   += $p2_sum;
						 //$win_per2 = (($players[$cur_player2]['score']+$p2_sum) / (($players[$cur_player1]['score']+$p1_sum) + ($players[$cur_player2]['score']+$p2_sum))) * 100;
						//$players[$cur_player2]['winper'] = number_format($win_per2, 2);
					  }
				  }

						//arsort($players);
						//echo "<pre> "; print_r($players);  echo "<br />"; exit;
				...
				if($i==1){ echo "<td align='left'>N/A</td>"; }
...
<script type="text/javascript">window.PixleeAsyncInit = function() {Pixlee.init({apiKey:'_h2dJMrIM0wF-ooa9aeI'});Pixlee.addSimpleWidget({widgetId:'22003'});};</script>
