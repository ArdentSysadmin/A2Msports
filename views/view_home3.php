...
<a  class="btn_banner" href="#popup1" type="button" style="margin-bottom: 60px;">Request a Demo <br></a>
...
<div class="row">
<div class="col-lg-12">
<div class="heading text-center pt-5 pb-3" id='clubFeatures'>
...
<div class="carousel-inner">
<div class="carousel-item active">
<div class="mx-3 pt-2 mb-5 ">
<div class="container-fluid">
<div class="row">
<div class="col-lg-6">
<div class="pt-3 px-5 banner_three_one text-center text-light">
   <h2>Pay and Play</h2>
...
<div class="col-lg-6">
<div class="pt-3 px-5 banner_three_two text-center">
...
<div class="container-fluid">
<div class="row">
<div style='padding-bottom:0px !important; padding-top:3rem !important;' class="heading text-center pt-5 pb-5">
...
<div class="container-fluid">
<div class="row">
<div class="heading text-center pt-4 pb-0">
<h1>Testimonials</h1>
</div>
</div>
<div class="row" style="margin-top: -45px">
...
<p>I got all I need for my academy and more from A2M Sports. It's a great platform with exceptional customer service. 
<br /><br /></p>
...
<div class=" p-4">
<img src="<?=$source;?>images/coma.png" class="w-10 mb-3">
 <p>A2M sports has been a real game changer for my business. It was an integral part of us not only surviving but thriving during the pandemic.<br /><br /></p>
<div class="review_name d-flex justify-content-start align-items-center">
<img src="<?=base_url()."assets_new/";?>images/Khaleel.png" class="w-15">
<h6 class="mx-3">Khaleel<br />WDCTT</h6>
</div>
</div>
</div>
</div>
