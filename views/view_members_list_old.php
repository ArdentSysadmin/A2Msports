...
<form method="post" id="myform"  action="<?php echo base_url(); ?>search/search_user"> 
...
<form method="post" id="myform"  action="<?php echo base_url();?>search/search_coach"> 
...
<form method="post" id="myform_match" action="<?php echo base_url(); ?>search/search_matches"> 
...
<form method="post" id="myform_match" action="<?php echo base_url(); ?>search/search_tournaments"> 
<!-- <label class='control-label col-md-1' for='id_accomodation' style="padding-left:0px; padding-top:5px">Search:</label> -->
