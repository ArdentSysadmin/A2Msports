...
if($rr_matches[$m]->Player1_Partner){
	...
	$p1_part = "; <a href='".$profile_base."player/".$player1_partner['Users_ID']."'>$player1_partner[Firstname] $player1_partner[Lastname]</a>";
}

if($rr_matches[$m]->Player2_Partner){
	$player2_partner = league::get_username(intval($rr_matches[$m]->Player2_Partner));
	$p2_part = "; <a href='".$profile_base."player/".$player2_partner['Users_ID']."'>$player2_partner[Firstname] $player2_partner[Lastname]</a>";
}
...
echo "<a href='".$profile_base."player/".$player1['Users_ID']."'>".$player1['Firstname']." ".$player1['Lastname']."</a>".$p1_part." ".$player1_loc_icon; 
...
echo "<a href='".$profile_base."player/".$player2['Users_ID']."'>".$player2['Firstname']." ".$player2['Lastname']."</a>".$p2_part." ".$player2_loc_icon;
...
<?php
		...
		if($get_name_partner){
			echo "<b>"."<a href='".$profile_base."player/".$get_name['Users_ID']."'>".$get_name['Firstname'][0]." ".$get_name['Lastname']."</a>";
			echo "; <a href='".$profile_base."player/".$get_name_partner['Users_ID']."'>".$get_name_partner['Firstname'][0].".".$get_name_partner['Lastname']."</a>";
		}
		else{
			echo "<b>"."<a href='".$profile_base."player/".$get_name['Users_ID']."'>".$get_name['Firstname']." ".$get_name['Lastname']."</a>";
		}
		echo "</b>";
...
<td align='center'><?php echo $res_ratings['init']; ?></td>
<td align='center'><?php echo $res_ratings['final']; ?></td>
<td align='center'><?php echo $res_ratings['change']; ?></td>
</tr>
<?php
}
?>
...
?>
<tr>
<td align="center"><?="<b>"."<a href='".$profile_base."player/".$p1."'>".$grid_array[$p1]['player_name']."</a>"."<a href='".$profile_base."player/".$grid_array[$p1]['partner']."'>".$grid_array[$p1]['partner_name']."</a>";?></td>
