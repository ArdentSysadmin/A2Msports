...
<section id="single_player" class="secondary-page" style="background:#fff;">
<div class='container'>
...
if(count($news_list) == 0) {
	?>
<tr><td colspan='3'><h5>Latest news is not yet created.</h5></td></tr>
<?php
}
else {
...
?>
<tr>
<td valign="center" align="left" style="padding:7px; width:100%">
<div style="font-size:15px; padding-bottom:6px;"><a href='<?php echo base_url().$this->short_code."/news/view/".$row->News_id;?>'><b><?php echo $row->News_title; ?></b></a></div>

<div align='right' style="margin-top:-17px">
<b><?php echo date('m/d/Y',strtotime(substr($row->Created_on,0,10))); ?></b>
</div>
