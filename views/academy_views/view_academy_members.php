...
?>
<form method="post" id="search_form"  action="<?=$this->config->item('club_form_url');?>/search_members<?=$stat;?>"> 
...
<div class='form-group' id="rpform" style="display:none">	
	...
	<form name='register_form' id='register_form' method='POST' action='<?=base_url();?>register/instant_clubmember/' enctype='multipart/form-data'>
<div class='row'>
<div class='col-md-6'>
