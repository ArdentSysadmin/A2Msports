...
$.ajax({
type:'POST',
url:baseurl+short_code+'/get_tour_row_info/',
...
<form method="post" action="<?php echo base_url().$short_code; ?>/view_matches">
...
<input type='checkbox' name="<?php echo $round_matches[$m]->Tourn_match_id; ?>" id='wff_add' class='wff_score' />&nbsp;Declare winner by Win by Forfeit
		 ...
		 <!-- ---------------Mobile view------------------------------------------------------- -->
					<div class="scoretable-mob">
					    ...
					    <tr>
							...
							<td><input id='mcd_set1_1_<?php echo $round_matches[$m]->Tourn_match_id; ?>' name='player1[]' style = "width:65%" type='text' maxlength='2' /></td>
							<td><input id='mcd_set2_1_<?php echo $round_matches[$m]->Tourn_match_id; ?>' name='player2[]' style = "width:65%" type='text' maxlength='2' /></td>
					   </tr>
						...
						<td><input id='mcd_set1_2_<?php echo $round_matches[$m]->Tourn_match_id; ?>' name='player1[]' style = "width:65%" type='text' maxlength='2' /></td>
						<td><input id='mcd_set2_2_<?php echo $round_matches[$m]->Tourn_match_id; ?>' name='player2[]' style = "width:65%" type='text' maxlength='2' /></td>
						</tr>
						<tr>
						<td>
							<?php echo $set_or_game . "3"; ?>
						</td>
						<td><input id='mcd_set1_3_<?php echo $round_matches[$m]->Tourn_match_id; ?>' name='player1[]' style = "width:65%" type='text' maxlength='2' /></td>
						<td><input id='mcd_set2_3_<?php echo $round_matches[$m]->Tourn_match_id; ?>' name='player2[]' style = "width:65%" type='text' maxlength='2' /></td>
						</tr>
						<tr>
						<td>
							<?php echo $set_or_game . "4"; ?>
						</td>
						<td><input id='mcd_set1_4_<?php echo $round_matches[$m]->Tourn_match_id; ?>' name='player1[]' style = "width:65%" type='text' maxlength='2' /></td>
						<td><input id='mcd_set2_4_<?php echo $round_matches[$m]->Tourn_match_id; ?>' name='player2[]' style = "width:65%" type='text' maxlength='2' /></td>
						</tr>
						<tr>
						<td>
							<?php echo $set_or_game . "5"; ?>
						</td>
						<td><input id='mcd_set1_5_<?php echo $round_matches[$m]->Tourn_match_id; ?>' name='player1[]' style = "width:65%" type='text' maxlength='2' /></td>
						<td><input id='mcd_set2_5_<?php echo $round_matches[$m]->Tourn_match_id; ?>' name='player2[]' style = "width:65%" type='text' maxlength='2' /></td>
						</tr>
	...
	<div class='form-group'>
	<div class='col-md-1 form-group internal'>
	<input name="cd_upd_match_score" id="<?php echo $round_matches[$m]->Tourn_match_id;?>" type="submit" value="Update" class="league-form-submit"/>
	</div>
	</div>
