...
echo $this->load->view('academy_views/includes/sreenidhi_academy_league_header');
}
else{
...
<body>
<?php
 if($org_details['Aca_URL_ShortCode'] == 'gpa'){
?>
<style>
h1, h2, h3, h4, h5, h6 {
...
<li><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/tournaments">Tournaments</a></li>

<li class="dropdown dropdown-toggle">
<a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/#">Clubs <i class="fa fa-angle-down"></i></a>
<ul class="dropdown-menu">
	<!-- <li><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/club_benefits">Club Benefits</a></li> -->
	<li><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/clubs">Clubs List</a></li>
	<li><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/register">Become a GPA Club</a></li>
</ul>
</li>

<li class="dropdown dropdown-toggle">
<a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/#">Players <i class="fa fa-angle-down"></i></a>
<ul class="dropdown-menu">
	<li><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/members">Members</a></li>
	<li><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/ratings">Ratings</a></li>
	<li><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/rankings">Rankings</a></li>
	<li><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/member_benefits">Member Benefits</a></li>
	<?php
		if(!$this->logged_user){
	?>
...
?>
<li class="dropdown dropdown-toggle">
<a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/#">Play <i class="fa fa-angle-down"></i></a>
<ul class="dropdown-menu">
	<li><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/places2play">Places to play</a></li>
	<li><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/ratings">Challenge Players</a></li>
</ul>
</li>
<?php 
...
!in_array('6', $club_menu) or 
!in_array('8', $club_menu) or 
...
<?php
	...
	?>
	<li><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/facility#gallery">Gallery</a></li>
	<li><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/facility#videos">Videos</a></li>
	<?php
...
<li>
<a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/#">Clubs</a>
<ul>
	<!-- <li><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/club_benefits">Club Benefits</a></li> -->
	<li><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/clubs">Clubs List</a></li>
	<li><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/register">Become a GPA Club</a></li>
...
<li>
<a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/#">Players</a>
<ul>
	<li><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/members">Members</a></li>
	<li><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/ratings">Ratings</a></li>
	<li><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/rankings">Rankings</a></li>
...
?>
<li>
<a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/#">Play</a>
<ul>
	<li><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/places2play">Places to play</a></li>
	<li><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/ratings">Challenge Players</a></li>
</ul>
...
?>
<li>
<a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/#about">More</a>
	<ul>
<?php
	//if($org_details['Aca_ID'] == '1123'){ ?>
	<!-- <li>
