...
<?php if($org_details['Aca_URL_ShortCode'] == 'gpa'){ ?>
<li><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/ratings">
Ratings</a></li>
<li><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/clubs">
Clubs</a></li>
<li><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode']; ?>/tournaments">
GPA Tournaments</a></li>
<?php 
}
