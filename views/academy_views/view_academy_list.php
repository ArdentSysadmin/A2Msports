...
foreach($academy_list as $row) { 
	if(!strpos($row->Aca_URL_ShortCode, 'ttps') and !strpos($row->Aca_URL_ShortCode, 'ttp') and !strpos($row->Aca_URL_ShortCode, '.com')){
?>
<tr>

<td valign="center" align="center"><h4>
<a href='<?php echo base_url().$row->Aca_URL_ShortCode; ?>'><b><?php echo $row->Aca_name; ?></a></b>
</h4>
</td>
