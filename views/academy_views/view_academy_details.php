...
$(document).ready(function(){
	 $("#bnr_submit").click(function(){
			  ...
			  // alert(prevFile);
               ...
               if (s > 10){
                  alert("Total of 10 images are allowed!");
				  return false;
               }
     });
...
<!-- edit icon end -->
	...
	<img src="<?php echo base_url(); ?>profile_pictures/<?php echo $pom_user['Profilepic'];?>"  style="/*width:175px; */ object-fit: contain; height:245px;" alt="">
	<?php } else { ?>
...
?>
	...
	<!-- <div class="text-center col-md-3 col-md-offset-3"> -->
		 <div class="course-item">
			...
			?>" alt="" style="/*width:261px;*/ object-fit: contain; height:157px; margin-top: 5px;" />
			</a>
			</div>
			<div class="course-body">
				<div class="course-desc" style="min-height: 115px;">
					<h4 class="course-title" style='font-size:15px;'><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode'].'/events/'.$row->Ev_ID; ?>" title="<?php echo $row->Ev_Title;?>">
					<?php if(strlen($row->Ev_Title) > 24) { echo substr($row->Ev_Title, 0, 24).".."; } else { echo $row->Ev_Title; }?></a></h4>
					  <p><b>Sport:</b> <?php 
						...
						if($get_loc['loc_city'] or $get_loc['loc_state']){
						?>
		 ...
		 <div class="course-item">
			...
			<div class="course-body">
				<div class="course-desc">
					<h4 class="course-title" style='font-size:15px;'><a href="<?php echo base_url().$org_details['Aca_URL_ShortCode'].'/league/'.$row->tournament_ID; ?>" title="<?php echo $row->tournament_title;?>">
					<?php if(strlen($row->tournament_title) > 23){ echo substr($row->tournament_title, 0, 23).".."; } else { echo $row->tournament_title; }?></a></h4>
					  <p><b>Sport:</b> <?php 
  ...
  <div class="container">
	...
	<?php } ?>>
		...
		?>
			...
			<img src="<?=$ps_img; ?>" alt="" style="/*width:50%; height:auto; */ object-fit: contain; height: 145px; border: 1px; background: none !important;">
			</div>
		...
		?>
		<div class="col-md-12 col-sm-6" align='center'>No Partners and Sponsors are added yet!</div>
		<?php
				}
		?>
		</div>
...
<div class="testimonials-wrapper">
  <div class="container">
    ...
    <div id="testimonials" <?php if($club_testimonials){ ?>
	class="owl-carousel" 
	<?php } ?>>
	<?php
