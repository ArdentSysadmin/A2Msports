...
<form method="post" id="myform" action='<?=$this->club_form_url;?>league/bracket_save' 
class="col-md-12 login-page"> 
...
$mdate = "<input type='text' placeholder='Date' name='game_date[{$round}{$match}][]' id='match_date{$round}{$match}' value='' />";
