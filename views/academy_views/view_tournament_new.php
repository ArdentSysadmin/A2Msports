...
if($tour_details->Usersid == $users_id or $this->is_super_admin){    /// tournament admin access links
...
if(($tour_details->Usersid == $users_id or $this->is_super_admin) and $cdate <= $exp_date) {   /// tournament admin access links
?>
