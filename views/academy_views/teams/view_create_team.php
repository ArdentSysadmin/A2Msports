...
<form class="form-horizontal" id='myform' method='post' role="form" action="<?php echo base_url(); ?>teams/create">
...
<p>
<input class='ui-autocomplete-input form-control inwidth' id='home_court' name='home_court' type='text' placeholder="Home Court Location" value="" />
...
<input name="bulk_register" type="submit" value="Create Team" class="league-form-submit1"/>
</div>
