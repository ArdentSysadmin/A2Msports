...
<td width="6%" class="score-position1" align='center'><input type='checkbox' name="sel_all" id="sel_all" /></td>
...
if(!$avail)
{?>
<input type="checkbox" name="sel_team_player[]" class="checkbox1" value="<?php echo $player;?>" />
<?php
} else {?>
<img src="<?=base_url();?>/icons/info_ico.png" title="Player is already part of another team for this Tournament" width='13px' height='13px' />
<?php
} ?>
</td>
