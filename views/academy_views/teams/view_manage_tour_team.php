...
<form name='frm_manage_team' action='<?=base_url();?>teams/update_team' method='POST'>
<div class="fromtitle">Add / Manage Team Players</div>
...
if($status == 1)
{?>
<img src="<?=base_url();?>/images/info_ico.png" title="Player is already part of another team for this Tournament" width='13px' height='13px' />
<?php
} else {?>
...
<input type="submit" value="Update Team" name='upd_players' style="margin-top:20px" class="league-form-submit" />
</div>
</form>