...
<p><label>Event Title: </label>
<?php echo $ev_det['Ev_Title'];?>
</p>
...
if($users_id){
?>
<div align='center' style="margin-top: 20px;"><a href='#comments'><b>Add / View Comments</b></a></div>
<?php
}
...
<a class="league-form-submit1" style='display:inline; cursor:pointer;' id='user_tshirt' name='user_tshirt'>UPDATE</a>
</span>
...
<br />
<div class="col-md-4 txt-torn1" style="padding-left:0px; margin-bottom:20px">
<a class="league-form-submit1" href="#div1" id="showdiv1" style="cursor:pointer;">Send Invites</a></div>

<div class="col-md-4 txt-torn1" style="padding-left:0px; margin-bottom:20px">
<a class="league-form-submit1" href="#div2" id="showdiv2" style="cursor:pointer;">Track/ Update Schedule</a></div>

<div class="col-md-4 txt-torn1" style="padding-left:0px; margin-bottom:20px">
<a class="league-form-submit1" href="#div3" id="showdiv3" style="cursor:pointer;">Send Email to Players</a></div>

<div class="col-md-4 txt-torn1" style="padding-left:0px; margin-bottom:20px">
<a class="league-form-submit1" href="#div4" id="showdiv4"  style="cursor:pointer;">Upload Images</a></div>

<!-- <div class="col-md-4 txt-torn1" style="padding-left:0px; margin-bottom:20px">
<a href="#div5" id="showdiv5"  style="cursor:pointer;">TShirt Sizes</a></div> -->

<div class="col-md-4 txt-torn1" style="padding-left:0px; margin-bottom:20px">
<a class="league-form-submit1" onclick="refresh_blog(<?php echo $ev_det['Ev_ID'];?>)" style='cursor:pointer;'>View Gallery</a></div>
...
<?php
	...
	$arr = array('redirect_tooo' => current_url());
...
<a class="btn btn-primary" style="background-color: #f59123; border-color: #f59123; color:#FFF" href="<?php echo $this->config->item('club_pr_url'); ?>/login/<?php echo $ev_det['Ev_ID'];?>">Login to RSVP</a>
...
<form id='frm_reg_attend' name='frm_reg_attend' action='<?=$this->config->item('club_pr_url');?>/events/reg_user2' method='POST'>
<input type="hidden" id="ev_id"		name="ev_id"	  value="<?php echo $ev_det['Ev_ID'];?>" />
