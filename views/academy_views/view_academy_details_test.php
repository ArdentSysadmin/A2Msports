  ...
  <div class="banner-wrapper">
	...
	<?php if($this->is_club_admin){ ?>
		<div class="facility-edit-icon">
             <a style="color:#fff; cursor:pointer;" id='change_club_img'><i class="fa fa-pencil" aria-hidden="true"></i></a>
        </div>
	<?php } ?>
<!-- edit icon end -->
		<?php 
...
action="<?=$this->config->item('club_form_url');?>/facility/add_banner" enctype='multipart/form-data'>
 ...
 <div class="col-md-3 player-month">
	<div class="pmonth-text">Player of the Month test</div>
<!-- edit icon -->
	<?php if($this->is_club_admin){ ?>
...
<!-- edit icon end -->
	...
	<img src="<?php echo base_url(); ?>profile_pictures/<?php echo $pom_user['Profilepic'];?>"  style="width:150px; height:150px;" alt="">
	<?php } else { ?>
				...
				<div class="course-body" align="center">
					<div class="course-desc" style='min-height:0px;'>
						<h4 class="course-title">
							...
							<!--<b> Location:</b> <?php echo $member['City'] . ", " . $member['State']; ?><br>
							<b>A2M Score:</b> <?php echo $member['A2MScore']; ?></p> -->
					</div>
				</div>
			</div><!-- Tournaments-item -->
		</div><!-- col-md-4 -->
...
<section class="home-about-bg" id='about'>
  <div class="container">
	...
	//}
	?>
	<div class="row about-row about-pad">
	  <div class="col-md-3">&nbsp;</div>
	 <?php
