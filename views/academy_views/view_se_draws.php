...
<br />
	...
	if($round == 1 and ($tour_details->Usersid == $this->logged_user or $this->is_super_admin)){
		...
		echo "<a  href='".base_url()."player/".$get_username['Users_ID']."' target='_blank'>".ucfirst(strtolower($get_username['Firstname']))." ".ucfirst(strtolower($get_username['Lastname']))."</a>";

			if($get_partner_username){
				echo " - <a href='".base_url()."player/".$get_partner_username['Users_ID']."' target='_blank'>".ucfirst(strtolower($get_partner_username['Firstname']))." ".ucfirst(strtolower($get_partner_username['Lastname']))."</a>"; 
			}
	...
	<?php if($list_matches[$m]->Round_Num == 1 and $list_matches[$m]->Player2 != 0 and $sp)
		{ 
		echo "<a href='".base_url()."player/".$get_username2['Users_ID']."' target='_blank'>".ucfirst(strtolower($get_username2['Firstname']))." ".ucfirst(strtolower($get_username2['Lastname']))."</a>"; 
			if($get_partner_username2){
				echo " - <a href='".base_url()."player/".$get_partner_username2['Users_ID']."' target='_blank'>".ucfirst(strtolower($get_partner_username2['Firstname']))." ".ucfirst(strtolower($get_partner_username2['Lastname']))."</a>"; 
			}
		}
...
<br />
	...
	<?php if($list_matches[0]->Round_Num == -1 and $list_matches[0]->Player2 != 0)
		{ 
		echo "<a href='".base_url()."player/".$get_username2['Users_ID']."' target='_blank'>".$get_username2['Firstname']." ".$get_username2['Lastname']."</a>"; 
			if($get_partner_username2){
				echo " - <a href='".base_url()."player/".$get_partner_username2['Users_ID']."' target='_blank'>".$get_partner_username2['Firstname']." ".$get_partner_username2['Lastname']."</a>"; 
			}
		}
