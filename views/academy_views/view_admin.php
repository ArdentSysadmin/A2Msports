...
<section id="single_player" class="container secondary-page">
	...
	<div class="top-score-title right-score col-md-9">
		...
		<form class="form-horizontal" id='myform' method='post' role="form"  action="<?php echo base_url(); ?>admin/send_email"> 
			 ...
			 <div class="col-md-12 league-form-bg" style="margin-bottom:20px;">
                ...
                <div class="col-md-12">
						...
						<br />
						  ...
						  <div id="load-users" style="overflow:auto;height:450px;width:780px;">
						...
						<input type="submit"  name="admin_email"  value="Send" class="league-form-submit1" style="margin:20px 0px"/>
