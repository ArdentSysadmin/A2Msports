...
<?php if($org_details['Home_Layout'] == 'video'){ ?>
  ...
  <div class="" id='home-video'>
	...
	<?php } ?>
	<!-- edit icon end -->
<div class="col-md-12 blue-bg" style="background-color:#123176; padding-right: 0px;">
	<?php
...
<div class="col-md-4 homevideo-top" style="text-align: center;">
<p style='padding-top:55px'>
<img src='<?=base_url();?>assets/club_pages/sreenidhi/sreenidhi_white.png' style="width:auto; height:300px;" />
</p>
<p style='padding-top:30px;color:#fff;'><b>We Nurture The Pattern Of Striving For Excellence.</b></p>

<div class="tshirt-buy" style="margin-top: 30px;">
	<a id="about_us" class="btn" href="/about-us" style="background:#fff;color:#000;border:0px;font-weight:bold;" onclick="myFunction();">About Us</a>&nbsp;&nbsp;&nbsp;
	<a id="programs" class="btn" href="/#our_programs" style="background:#fff;color:#000;border:0px;font-weight:bold;" onclick="myFunction();">Programs</a>
</div>
</div>

<div class="col-md-8 homevideo-top" style='margin-top:0px;margin-bottom:0px;margin-bottom:-8px;padding-right: 0px;'>
<video id="example_video_1" class="video-js vjs-default-skin vjs-paused vjs-controls-enabled vjs-user-inactive" controls autoplay muted loop preload="none" width="100%" poster="<?=base_url();?>images/gpa_video2.jpg" data-setup="{}">
<source src="<?=$home_video;?>" type="video/mp4" />
...
<section class="inner-page-wrapper course-list-wrapper" style="margin-bottom:-60px; background: #fff url(images/crossword.png) repeat;" id='our_programs'>
  <div class="container">
      <div class="title">
    ...
    <div class="row">
     <div class="col-md-4 col-sm-6">
		 <div class="course-item">
			<div class="vhead">ETZ PLUS (Community)</div>
			<div class="course-img"><img src="<?php echo base_url()."assets/club_facility/".$org_id; ?>/ETZ_PLUS_Community_HOME.jpg" alt=""></div>
			<div class="course-body">
				<div class="course-desc">
					  <p id="ETZPDescription">SNSA provides multi- sports program for the communities across a multitude of sports.... <!-- Our enthusiastic, qualified and friendly staff will educate the children regarding the techniques, tactics and rules of the game in a fun, optimal learning environment. We also organise community leagues leagues and tournaments. --></p>
					  <div style="text-align:center; padding:10px 0px"><a class="btn" href="/etz-plus" style="background: #123176; color: #fff; border:0px" onclick="myFunction2();">Find Out More</a></div>
				</div>
			</div>
	...
	<div class="col-md-4 col-sm-6">
		 <div class="course-item">
			<div class="vhead">ETZ (School)</div>
			<div class="course-img"><img src="<?php echo base_url()."assets/club_facility/".$org_id; ?>/ETZ_School_HOME.jpg" alt=""></div>
			<div class="course-body">
				<div class="course-desc">
					  <p id="ETZDescription">ETZ program is designed to provide students with the opportunity.... <!--  to receive professional coaching before and after the normal academic time in the sports chosen. The sessions are conducted by a team of highly qualified coaches and sports mentors for ages 5 - 18. This approach enables students to <span id="moreText" style="display: none;">experiment with different activities and discover new abilities and interests. We believe that a strong foundation built in early life continues to hold steady throughout the later years. Participation in an ETZ program affords opportunities, training, and experiences not ordinarily available in the regular curriculum.</span> --></p>
					  <div style="text-align:center; padding:10px 0px">
					  <!-- <a id="etzSchool" class="btn" href="#actDis" style="background: #123176; color: #fff; border:0px" onclick="myFunction();">Find Out More</a> -->
					  <a id="etzSchool" class="btn" href="/etz-school" style="background: #123176; color: #fff; border:0px" onclick="myFunction();">Find Out More</a>
					  </div>
				</div>
			</div>
		</div><!-- Tournaments-item -->
...
.vhead2:hover {
  height: 55px;
	...
	<div class="col-md-4 col-sm-6">
		 <div class="course-item">
			<div class="vhead2">Athletic & Individual Development Program</div>
			<div class="course-img"><img src="<?php echo base_url()."assets/club_facility/".$org_id; ?>/Elite_Program_Home.jpg" alt=""></div>
			<div class="course-body">
				<div class="course-desc">
					  <p id="AcaDescription">Performance goes past physical abilities. Our distinctive 
Athletic & Individual Development... <!-- program that provides ample opportunities for student-athletes who intend to forge a career in sports. These Athletes will participate in the Inter-school, District, State, National, and International events and competitions. <span id="moreText" style="display: none;"> Athletes in the Elite program train an average of four hours per day.</span> --></p>
					  <div style="text-align:center; padding:10px 0px"><a class="btn" href="/elite-program" style="background: #123176; color: #fff; border:0px" onclick="myFunction3();">Find Out More</a></div>
				</div>
			</div>
		</div><!-- Tournaments-item -->
	</div><!-- col-md-4 -->
	<!-- <div class="col-md-3 col-sm-6">
		 <div class="course-item">
			<div class="vhead">Virtual Training Lab</div>
			<div class="course-img"><img src="<?php echo base_url()."assets/club_facility/".$org_id; ?>/Virtual_Lab_Home.jpg" alt=""></div>
			<div class="course-body">
				<div class="course-desc">
					  <p id="VTLDescription">VIRTUAL TRAINING LAB" is a program that comprises recorded videos and live virtual.... </p>
					  <div style="text-align:center; padding:10px 0px"><a class="btn" href="/virtual-training" style="background: #123176; color: #fff; border:0px" onclick="myFunction1();">Find Out More</a></div>
				</div>
			</div>
		</div>
	</div> --><!-- col-md-4 -->      
...
<!-- Our Activities Wrapper Start -->
<section class="our-gallery-wrapper" id="program_section" style="padding: 10px 0 100px;">
  <div class="container">
  ...
  <div class="container">
    <div id="home-gallery1" class="owl-carousel">
      <div class="item">
		<div class="course-item">
			<div class="course-img"><img src="<?=base_url();?>/assets/club_pages/sreenidhi/1.png" alt=""></div>
			<div class="course-body">
				<div class="course-desc">
					<h4 class="course-title"><a href="#">Athletics</a></h4>
				</div>
			</div>
		</div><!-- Activities-item -->
	  </div>
	   ...
	   <div class="item">
		<div class="course-item">
			<div class="course-img"><img src="<?=base_url();?>/assets/club_pages/sreenidhi/2.png" alt=""></div>
			<div class="course-body">
				<div class="course-desc">
					<h4 class="course-title"><a href="#">Swimming</a></h4>
				</div>
			</div>
		</div><!-- Activities-item -->
	  </div>
      ...
      <div class="item">
		<div class="course-item">
			<div class="course-img"><img src="<?=base_url();?>/assets/club_pages/sreenidhi/3.png" alt=""></div>
			<div class="course-body">
				<div class="course-desc">
					<h4 class="course-title"><a href="#">Roller Skating</a></h4>
				</div>
			</div>
		</div><!-- Activities-item -->
	  </div>
	  ...
	  <div class="item">
		<div class="course-item">
			<div class="course-img"><img src="<?=base_url();?>/assets/club_pages/sreenidhi/4.png" alt=""></div>
			<div class="course-body">
				<div class="course-desc">
					<h4 class="course-title"><a href="#">Tennis</a></h4>
				</div>
			</div>
		</div><!-- Activities-item -->
	  </div>
	  ...
	  <div class="item">
		<div class="course-item">
			<div class="course-img"><img src="<?=base_url();?>/assets/club_pages/sreenidhi/5.png" alt=""></div>
			<div class="course-body">
				<div class="course-desc">
					<h4 class="course-title"><a href="#">Badminton</a></h4>
				</div>
			</div>
		</div><!-- Activities-item -->
	  </div>
	  ...
	  <div class="item">
		<div class="course-item">
			<div class="course-img"><img src="<?=base_url();?>/assets/club_pages/sreenidhi/6.png" alt=""></div>
			<div class="course-body">
				<div class="course-desc">
					<h4 class="course-title"><a href="#">Squash</a></h4>
				</div>
			</div>
		</div><!-- Activities-item -->
	  </div>
	  ...
	  <div class="item">
		<div class="course-item">
			<div class="course-img"><img src="<?=base_url();?>/assets/club_pages/sreenidhi/7.png" alt=""></div>
			<div class="course-body">
				<div class="course-desc">
					<h4 class="course-title"><a href="#">Martial Arts</a></h4>
				</div>
			</div>
		</div><!-- Activities-item -->
	  </div>
	  ...
	  <div class="item">
		<div class="course-item">
			<div class="course-img"><img src="<?=base_url();?>/assets/club_pages/sreenidhi/8.png" alt=""></div>
			<div class="course-body">
				<div class="course-desc">
					<h4 class="course-title"><a href="#">Football</a></h4>
				</div>
			</div>
		</div><!-- Activities-item -->
	  </div>
	  ...
	  <div class="item">
		<div class="course-item">
			<div class="course-img"><img src="<?=base_url();?>/assets/club_pages/sreenidhi/9.png" alt=""></div>
			<div class="course-body">
				<div class="course-desc">
					<h4 class="course-title"><a href="#">Basketball</a></h4>
				</div>
			</div>
		</div><!-- Activities-item -->
	  </div>
...
<section class="inner-page-wrapper course-list-wrapper tournaments-bg1" style="margin-bottom:-60px; padding: 10px 0 50px;">
...
<section class="blog-wrapper" style="padding: 10px 0 50px;">
        ...
        <div class="single-blog">
          <div class="blog-content">
			...
			<h3> <a href="<?=$this->config->item('club_form_url');?>/news/view/<?=$row->News_id;?>"><?php echo $row->News_title; ?></a> </h3>
				...
				//$abc 	= html_entity_decode($row->News_content);
...
<section class="blog-wrapper" style="background:url(../images/ps-background.png); padding: 10px 0 100px;">
