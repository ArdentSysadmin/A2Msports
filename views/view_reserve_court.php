...
<div class="fromtitle">Reserve a Court or Table</div>
<p style="line-height:20px; font-size:13px">You can reserver a Court for any Racket Sport or a Table for Table Tennis from one of our partner clubs here.
...
<div class="col-md-12 league-form-bg" style="margin-top:30px; margin-bottom:30px">
	<div class="fromtitle">Select a Club</div>
