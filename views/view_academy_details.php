...
<!-- 	 <div class="col-md-2 profilelist"> </div>  -->
			...
			<div class="fromtitle">Search for Members</div>
				...
				<form method="post" id="myform"  action="<?php echo base_url().$org_details['Url_Shortcode'];?>/search_member"> 
				...
				<div class="fromtitle">Search for Coaches</div>
					...
					<form method="post" id="coach_form"  action="<?php echo base_url();?>academy/coaches"> 
