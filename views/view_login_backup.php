...
<input class='form-control' style='width:50%' id="txt_login" name="name_login" type="text" required/>
</div>
<div class="pwd">
<label for="password_login">Password:</label><div class="clear"></div>
<input class='form-control' style='width:50%' id="password_login" name="password_login" type="password" required/>
</div>
<br />
