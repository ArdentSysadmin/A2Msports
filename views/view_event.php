...
$(document).ready(function(){
	...
	$('#event_start_date, #event_end_date, #event_st_time, #event_end_time, #change_loc, #ev_loc').on('change', function(){
		...
		if(sch_type == 'daily'){
			...
			$.ajax({
                type:'POST',
                url:baseurl+'events/add_fields_weekly/',
...
<div class="fromtitle">Schedule an Event</div>
...
<br /><br />
Please <a href='<?php echo base_url()."login"; ?>'><b>Login</b> </a>to create an Event.</p>
<?php } ?>
</div>
...
<?php if($this->session->userdata('user')!="") { ?>	
	...
	<form class='form-horizontal' enctype="multipart/form-data" name='form-op-users' id='form-op-users' method="post" action='<?php echo base_url();?>events/create'>
	...
	<div class='form-group'>
	  ...
	  <div class='form-group'>
		<label class='control-label col-md-4' for='id_accomodation'><font color='red'>* </font> Sport</label>
	...
	<div id="sd_ed" style="display:none;">
		...
		<div class='form-group' id="start_date">
			<label class='control-label col-md-4' for='id_title'>Start & End Date</label>
			<div class='col-md-8 form-group internal'>
			<table>
			<tr>
	...
	<div class='col-md-9 form-group internal'>
		 Do you want to collect the fees for the event&nbsp;
	...
	<div class='form-group' id="div_fee_section" style="display:none;">
		<label class='control-label col-md-4' for='id_title'>Fee Amount</label>
		<div class='col-md-3 form-group internal'>
		<input type="number" id="fee_amount" name="fee_amount" class='form-control' />
		</div>

		<!-- <div class='col-md-9 form-group internal'>
			 Is fee should collect one time/per occurence of event&nbsp;
			<label for="chkYes"><input type="radio" id="isYes" name="fee_oc" value="Single" checked="checked" /> One Time</label>&nbsp;&nbsp;
			<label for="chkNo"><input type="radio" id="isNo" name="fee_oc" value="Multiple" /> Per Occurence<br /></label>
		</div> -->

	 </div> 

	<div class='form-group'>
	<label class='control-label col-md-4' for='id_accomodation'>Description / Summary </label>
	<div class='col-md-8 form-group internal'>
	<textarea name="ev_message" class="txt-area" id="ev_message" cols="20" rows="2"></textarea>
	</div>
	</div>
