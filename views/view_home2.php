         ...
         <div class="row">
           <div class="col-lg-6">
             <div class="banner_content text-start text-light pl-30 pt-3 pb-2">
               <!-- <div class="m_show">
                 <img src="<?=base_url()."assets_new/";?>images/Pickleball - Graphic.png" class="mb-3">
               </div> -->
               ...
               <a href="#contact" class="btn_banner">Request a demo</a>
             </div>
           </div>
           <div class="col-lg-6">
             <div class="banner_content text-start text-light pt-3 pb-2 relative">
              <div class="d-flex justify-content-between play_btn w-60 p-3">
                ...
                <a onclick="lightbox_open();" style="cursor: pointer;"><img src="<?=base_url()."assets_new/";?>images/play.png" style="cursor: pointer;"></a>
                <p class="mb-0 mt-3 mx-3">Watch how A2M connects the sports enthusiasts</p>

              </div> 
              <div id="slider d_show">  
			<div class="slides ">  
			  <img src="<?=base_url()."assets_new/";?>images/men.png" width="100%" class="slidrimg" />
			 </div>
			 <div class="slides">  
			  <img src="<?=base_url()."assets_new/";?>images/tennis-home.png" class="slidrimg" width="100%" />
			</div>
			 <div class="slides">  
			  <img src="<?=base_url()."assets_new/";?>images/tt-home.png" width="100%" class="slidrimg"/>
			</div> 
			 <div class="slides">  
			  <img src="<?=base_url()."assets_new/";?>images/pickleball-home.png" width="100%" class="slidrimg"/>
			</div> 
         ...
         <div class="row">
           ...
           <div class="col-lg-6">
             <div class="banner_img text-center">
               <img src="images/mobile.png" class="w-50">
             </div>
           </div>
         </div>
       </div>
     ...
     <div class="banner_two  mx-3 pt-5 mb-5 ">
       <div class="container-fluid">
         <div class="row">
           ...
           <div class="col-lg-6">
             <div class="banner_img text-center">
               <img src="<?=base_url()."assets_new/";?>images/mobile.png" class="w-50">
             </div>
           </div>
         </div>
       </div>
         ...
         <div class="row">
           <div class="col-lg-6 pl-100" >
             <div class="banner_two_content pl-30 pt-5 mx-3">
               ...
               <a href="<?=base_url()."login";?>" class="btn_orange">Add your Club here</a>
             </div>
           </div>
           <div class="col-lg-6">
             <div class="banner_img text-center">
    ...
    <div class="carousel-item active">
     <div class="  mx-3 pt-5 mb-5 ">
       <div class="container-fluid">
         <div class="row">
           <div class="col-lg-6">
             <div class="pt-5 px-5 banner_three_one text-center text-light" style="margin-top:10px;">
               <h2>Coach Booking</h2>
               <p class="mb-5">Schedule a Group or Private Lesson with Coaches<br /></p>
               <img src="<?=base_url()."assets_new/";?>images/mob_2.png" class="w-60">
             </div>
           </div>
           <div class="col-lg-6">
              <div class="pt-5 px-5 banner_three_two text-center" style="background-color: #f4f1ff; margin-top:10px;">
               <h2>Membership Management</h2>
               <p class="mb-5">Create unlimited number of Memberships and collect fees automatically</p>
               <img src="<?=base_url()."assets_new/";?>images/desktop.png" class="w-60">
             </div>
           </div>
         </div>
       </div>
     ...
     <div class="banner_two  mx-3 pt-5 mb-5 ">
       <div class="container-fluid">
         <div class="row">
           <div class="col-lg-6 pl-100" >
             <div class="banner_two_content pl-30 mx-3">
               <h1>Pay and Play <br>(Court Reservation System)</h1>
               <p>Weather it's a dedicated Tennis, Badminton, or Squash Court, Table Tennis Tables or a shared Swimming Pool, you can book them here .</p>
               <a href="<?=base_url()."login";?>" class="btn_orange">Sign up</a>
             </div>
       ...
       <div class="container-fluid">
         <div class="row">
           <div class="col-lg-12">
			   ...
			   <div class="slide"><img src="<?=base_url()."assets_new/";?>images/premium_clubs/ARC.png"></div>
			   <div class="slide"><img src="<?=base_url()."assets_new/";?>images/premium_clubs/AUSSINICK.png"></div>
			   <div class="slide"><img src="<?=base_url()."assets_new/";?>images/premium_clubs/SATTA.png"></div>
			   <div class="slide"><img src="<?=base_url()."assets_new/";?>images/premium_clubs/SBA.png"></div>
			   <div class="slide"><img src="<?=base_url()."assets_new/";?>images/premium_clubs/WDCTT.png"></div>
<div class="slide"><img src="<?=base_url()."assets_new/";?>images/premium_clubs/ARC.png"></div>
			   <div class="slide"><img src="<?=base_url()."assets_new/";?>images/premium_clubs/AUSSINICK.png"></div>
			   <div class="slide"><img src="<?=base_url()."assets_new/";?>images/premium_clubs/SATTA.png"></div>
      <!-- <div class="slide"><img src="<?=base_url()."assets_new/";?>images/c_logo (1).png"></div>
      <div class="slide"><img src="<?=base_url()."assets_new/";?>images/c_logo (2).png"></div>
      <div class="slide"><img src="<?=base_url()."assets_new/";?>images/c_logo (3).png"></div>
      <div class="slide"><img src="<?=base_url()."assets_new/";?>images/c_logo (4).png"></div>
      <div class="slide"><img src="<?=base_url()."assets_new/";?>images/c_logo (5).png"></div> -->   
				</section>
           </div>
         </div>
       </div>
  ...
  <div class="customer-logos slider">
    <div class="slide-in-right slide"><img src="<?=base_url()."assets_new/";?>images/c_logo (1).png" height="150" width="150"></a></div>
    <div class="slide-in-right slide"><img src="<?=base_url()."assets_new/";?>images/c_logo (2).png" height="150" width="150"></a></div>
    <div class="slide-in-right slide"><img src="<?=base_url()."assets_new/";?>images/c_logo (3).png" height="150" width="150"></a></div>
    <div class="slide-in-right slide"><img src="<?=base_url()."assets_new/";?>images/c_logo (4).png" height="150" width="150" alt=""></a></div>
    <div class="slide-in-right slide"><img src="<?=base_url()."assets_new/";?>images/c_logo (5).png" height="150" width="150" alt=""></a></div>
    <div class="slide-in-right slide"><img src="<?=base_url()."assets_new/";?>images/c_logo (1).png" height="150" width="150"></a></div>
    <div class="slide-in-right slide"><img src="<?=base_url()."assets_new/";?>images/c_logo (2).png" height="150" width="150"></a></div>
    <div class="slide-in-right slide"><img src="<?=base_url()."assets_new/";?>images/c_logo (3).png" height="150" width="150"></a></div>
    <div class="slide-in-right slide"><img src="<?=base_url()."assets_new/";?>images/c_logo (4).png" height="150" width="150" alt=""></a></div>
 ...
 <!--six banner end -->
           ...
           <div class="owl-carousel owl-theme Testimonials">
            ...
            <div class="item  ">
              <div class="testimonials_box">
                <div class=" p-4">
                  <img src="<?=base_url()."assets_new/";?>images/coma.png" class="w-10 mb-3">
                  <p>I got all I need for my academy and more from A2M Sports. It's a great platform with exceptional customer service. </p><br />
            ...
            <div class="item  ">
              <div class="testimonials_box">
                <div class=" p-4">
                  <img src="<?=base_url()."assets_new/";?>images/coma.png" class="w-10 mb-3">
                  <p>The app is very well organized and really all players liked it and helped them track the scores and matches. I highly recommend the app for all sport to use. </p>
                  <div class="review_name d-flex justify-content-start align-items-center">
                    <img src="<?=base_url()."assets_new/";?>images/SamAwadallah.jpg" class="w-15">
                    <h6 class="mx-3">Sameh Boshra</h6>
                  </div>
            ...
            <!--<div class="item  ">
              <div class="testimonials_box">
                <div class=" p-4">
                  <img src="<?=base_url()."assets_new/";?>images/coma.png" class="w-10 mb-3">
                  <p>I have seen the coaching here and it's really amazing how passionate they are about their kids. Very dedicated and hardworking team. I'm sure they will bring the best out of the kids. </p>
                  <div class="review_name d-flex justify-content-start align-items-center">
                    <img src="<?=base_url()."assets_new/";?>images/name.png" class="w-15">
  ...
  <!--seven banner start MOBILE VERSION-->
...
?>
     ...
     <!--seven banner end MOBILE VERSION-->
     ...
     <div class="mx-3 mb-5">
       <div class="container-fluid d_show">
         <div class="row">
           <div class="col-lg-6">
             <div class="Latest_newa" style="padding: 1.5rem 1.5rem 0.25rem 1.5rem !important;">
 <?php
 $i = 1;
foreach($results as $row){
...
View All </button>
	 ...
	 $(document).ready(function() {
		$('#news_btn').click(function (){
			window.location.href = "https://a2msports.com/news";
		});
	 });
	 </script>