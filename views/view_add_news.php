...
<form class="form-horizontal" id='myform' method='post' role="form"  action="<?php echo base_url(); ?>News/add_news"> 
...
<div>
<br />
<input type='checkbox' name='send_email_flag' id='send_email_flag' value='1' />
Do you want to notify the players about this news?
</div>
