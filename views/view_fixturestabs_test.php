...
<h3 style="text-align:left">Create Drawss</h3>
...
if($tourn_det){
?>
<form class="form-horizontal" id='myform' method='post' role="form" action="<?php echo base_url()."league/bracket/".$tourn_det['tournament_ID'];?>" autocomplete="off"> 
...
<div class='col-md-6 form-group internal'>
<input type='hidden' name='is_testing' id='is_testing' value='1' />
...
<?php if($this->session->userdata('draw')['ttype'] == 'Single Elimination') { echo "selected"; } ?>>Single Elimination</option>
<option value="Consolation" 
<?php if($this->session->userdata('draw')['ttype'] == 'Consolation') { echo "selected"; } ?>>Consolation</option>
<option value="Round Robin" 
<?php if($this->session->userdata('draw')['ttype'] == 'Round Robin') { echo "selected"; } ?>>Round Robin</option>
<option value="Switch Doubles">Switch Doubles</option>
<!-- <option value="Switch Doubles2">Switch Doubles - 2</option> -->
<?php if($this->session->userdata('draw')['ttype'] == "Challenge Ladder"){ ?>
...
<option value='conventional' <?php if($this->session->userdata('draw')['ttype'] == 'conventional') { echo "selected"; } ?>>Conventional</option>
<option value='drive_chip_putt' <?php if($this->session->userdata('draw')['ttype'] == 'drive_chip_putt') { echo "selected"; } ?>>Drive, Chip & Putt</option>
<?php
}
?>
</select>
