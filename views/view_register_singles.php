		  ...
		  <div class="col-md-12 league-form-bg">
                ...
                <div class="col-md-12">
                    ...
                    <!-- <div class="col-md-8"> -->
					    ...
					    <input name="singles_match" type="submit" value="Register" class="league-form-submit1" style="margin:20px 0px"/>

						<?php } ?>
						</div>
						</div>

                    <!-- </div> <input type="button" id="edit" value="EDIT" class="league-form-submit1" style="margin:20px 0px">-->
