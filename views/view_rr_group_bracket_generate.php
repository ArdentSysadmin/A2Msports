...
<form method="post" id="myform" action='<?php echo base_url(); ?>league/bracket_save' class="col-md-12 login-page" style='background-color:#fff'> 
...
<input class="form-control" type="text" name="draw_title[<?=$g;?>]" id="draw_title" placeholder='Draw Title' required />
