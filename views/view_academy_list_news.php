...
<div class="accordion" id="up_match_section" style="background:#f59123; padding:5px; color:white;"><i class="fa fa-arrow-circle-o-right" style="color:white;"> </i>Academy Latest News<span></span></div>
...
if(count($news_list) == 0 )
{
	?>
<tr>
<td colspan='3'><h5>Academy Latest news is not yet created.</h5></td>
</tr>
<?php
}
else
...
<div style="font-size:15px; padding-bottom:6px;"><a href='<?php echo base_url()."academy/get_news_detail/".$row->News_id;?>'><b><?php echo $row->News_title; ?></b></a></div>

<div align='right' style="margin-top:-17px"><b><?php echo date('m/d/Y',strtotime(substr($row->Created_on,0,10))); ?></b></div>
<div>
	<?php 
		//$s = substr($row->News_content, 0, 200);
