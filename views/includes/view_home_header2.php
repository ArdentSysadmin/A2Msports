...
<a class="navbar-brand" href="#"><img src="<?=$source;?>images/logo.png"></a>
...
<a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink_one" role="button" data-bs-toggle="dropdown" aria-expanded="false">Player Features   <i class="fas fa-chevron-down"></i>
</a>
