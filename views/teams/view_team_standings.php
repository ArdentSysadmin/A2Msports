...
$get_reg_level_teams = league::get_reg_level_teams($tourn_id, $sel_level);

foreach($get_reg_level_teams as $team){
$played	= 0;
$won	= 0;
$lost	= 0;
$tp		= 0;
//	foreach($get_level_brackets as $bracket){
	...
	$tourn_matches = league::get_team_tourn_matches($team->Team_id, $tourn_id);
