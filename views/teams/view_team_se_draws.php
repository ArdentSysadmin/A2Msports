...
<br />
	...
	<span class="teama"><?php
		if($get_team1){ 
		echo "<a style='text-decoration:none; cursor:default;'>".$get_team1['Team_name']."</a>";
		}
		else { echo "----"; }?>
	...
	<?php if($list_matches[$m]->Round_Num != 1){
		...
		$player2 = $get_source_scores1['Player2'];
             echo '<a class="show_linematch_score" style="decoration:none; cursor:default; font-weight:bold;" 
	...
	if($list_matches[$m]->Round_Num == 1 and $list_matches[$m]->Player2 != 0){ 
		echo "<a style='text-decoration:none; cursor:default;'>".$get_team2['Team_name']."</a>"; 
	}
...
<?php if($list_matches[$m]->Round_Num != 1){
		...
		//if($get_source_scores2['Player1_Score'] !=""){
		    ...
		    $player2 = $get_source_scores2['Player2'];
             echo '<a class="show_linematch_score" style="decoration:none; cursor:default; font-weight:bold;"            id="P2_'.$tourn_match_id.'_'.$player1.'_'.$player2.'">';
