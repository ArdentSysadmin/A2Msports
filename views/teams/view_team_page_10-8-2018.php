...
.container2 .content {
 ...
 <section id="single_player" class="container secondary-page">
   ...
   <div class="col-md-12 league-form-bg" style="margin-top:40px;">
		...
		<table class="col-md-12 tab-score">
		<thead>
			<tr class="top-scrore-table">
			<td class="col-md-6 score-position">Team</td>
			<td class="score-position">Home Location</td>
		...
		<tr>
			...
			foreach($team_players as $tp){
				...
				<a href='".base_url()."player/".$player['Users_ID']."' target='_blank'>".ucfirst($player['Firstname'])." ".ucfirst($player['Lastname'])." ".$gender."</a>&nbsp;{$captain_ico}</li>";
			}
		...
		<tr>
			...
			foreach($team_players as $tp){
				...
				echo "<li style='padding-left:25px;padding-bottom:5px;list-style:none;'>
				<a href='".base_url()."player/".$player['Users_ID']."' target='_blank'>".ucfirst($player['Firstname'])." ".ucfirst($player['Lastname'])."</a>&nbsp;{$captain_ico}</li>";
			}
...
<?php } ?>
   ...
   <div class="col-md-12 league-form-bg" style="margin-top:40px;">
		...
		<div class="tab-content table-responsive container2">
		<table class="tab-score" id="near_teams">
		<thead>
			<tr class="top-scrore-table">
				<td class="col-md-7 score-position">Team</td>
		...
		foreach($user_non_part as $unp){?>
			...
			echo "<div class='header'>$img_team_logo&nbsp;<span style='color:#03508c;font-size:13px;font-weight:400;'>".$unp->Team_name."&nbsp;&nbsp;&nbsp;(".$get_sport['Sportname'].")</span></div><div class='content'><ul>";
