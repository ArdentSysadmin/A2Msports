...
<td style="padding-left:15px;"><a href="#"><?php echo ucfirst($player1['Team_name'])."</a>"; 
...
<td style="padding-left:15px;"><a href="#"><?php echo ucfirst($player2['Team_name'])."</a>";
...
<?php
$get_name = league::get_team($rr_matches[$m]->Player1); 
$player1_name = $get_name['Team_name'];
?>
<?php 
$get_name = league::get_team($rr_matches[$m]->Player2);
$player2_name =  $get_name['Team_name'];
?>
...
<input class='form-control' value="TS_WFF" name="score_type" type='hidden'> 
...
<tr>
<td bgcolor="#fdd7b0"><b><?php echo $player1_name; ?></b></td>
...
<tr>
<td bgcolor="#fdd7b0"><b><?php echo $player2_name; ?></b></td>
...
<tr>
<th>Players</th>
<th bgcolor="#fdd7b0"><b><?php echo $player1_name; ?></b></th>
<th bgcolor="#fdd7b0"><b><?php echo $player2_name; ?></b></th>
<?php 
if($sport_id == 1){
$set_or_game = 'Set';
}
...
<input class='form-control' value="TS_ADDSCORE" name="score_type" type='hidden'> 
...
<div class='col-md-2 form-group internal'><input type="text" class='form-control' placeholder="Date" 
id="edate<?php echo $rr_matches[$m]->Tourn_match_id; ?>"name="tour_match_date" /></div>
...
<th bgcolor="#fdd7b0"><b><?php echo $player2_name; ?></b></th>
<?php 
if($sport_id == 1){ $set_or_game = 'Set'; }
else{ $set_or_game = 'Game'; }
...
echo "<b>".ucfirst($get_name['Team_name'])."</b>";
?>
</td>
<?php
$player_tot_score = 0;
