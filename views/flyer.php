...
<b>Venue:</b> 
 ...
 <table border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td style="padding:15px; line-height:20px; background:#eeeeee; border-radius:10px;"><?php if($tour_details->TournamentDescription!=""){echo html_entity_decode($tour_details->TournamentDescription); } else { echo "Sample instruction for the Tournament. Sample instruction for the Tournament. Sample instruction for the Tournament. Sample instruction for the Tournament. Sample instruction for the Tournament. Sample instruction for the Tournament. Sample instruction for the Tournament. Sample instruction for the Tournament. Sample instruction for the Tournament. Sample instruction for the Tournament. Sample instruction for the Tournament. Sample instruction for the Tournament. Sample instruction for the Tournament. Sample instruction for the Tournament. Sample instruction for the Tournament. Sample instruction for the Tournament. Sample instruction for the Tournament. Sample instruction for the Tournament. Sample instruction for the Tournament. Sample instruction for the Tournament. Sample instruction for the Tournament. "; }?> </td>
  </tr>
</table>
 </div>
