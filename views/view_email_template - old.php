...
<b>Fees</b>:
<?php if($is_mult == 0){ ?>
<?php echo "$" .number_format($fee,2)." (Singles), ". "$" . number_format($extrafee,2)." (Additional Format)";?> <br />
<?php } else if($is_mult == 1) { 
...
<div style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">Thank you, <br /> 
<?php echo $admin_name;?>, <br /> <?php echo $title;?>, <br /> A2M Sports. </div>
...
<br />
<?php echo "Paypal Return: {$paypal_vals}"; ?><br />
<br />
</div>
...
<?php echo "Given below are the paypal details:"; ?>	
<br />
<?php echo "Post Return: {$post_vals}"; ?><br />
<br />
</div>
...
<div style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">
<?php echo "You have been withdrawn from the tournament '{$title}' by the Tournament Admin."; ?><br />
<?php if($Ref_Amt){ ?>
...
<?php } ?>
<br />
<?php echo "If you have any queries please write to us at admin@a2msports.com."; ?><br />
...
© 2016 a2msports.com. All rights reserved.</td>
</tr>
 <?php if($unsubscribe){?>
<tr>
