...
<a href="<?=base_url()?>sponsor/<?=$tour_details->tournament_ID;?>" style='cursor:pointer;margin-right:40px;' target='_blank'>
<img src='<?=base_url();?>icons/become-a-sponsor.png' alt='Become a Sponsor' title='Become a Sponsor' width='200px'>
</a>
</div>
