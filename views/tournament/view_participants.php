...
$(document).ready(function(){
	$('.user_change_partner').change(function(){
		...
		//alert($(this).val())
		if(Partner != ''){
		if(confirm("Are you sure to change your event partner?")){
			//alert(Event);
...
<td class="score-position" valign="center" align="center"><?php echo $avg_score; ?></td>
<?php
if($tour_details->SportsType == '2'){
...
<td class="score-position" valign="center" align="center"><?php echo $user_score; ?></td>
<?php
