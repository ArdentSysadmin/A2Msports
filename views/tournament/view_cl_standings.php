...
if(!$this->is_team_league){
?>
<th class="text-center">Init A2M</th>
<th class="text-center">Final A2M</th>
...
?>
	...
	$(document).ready(function() {
	$('#standings').dataTable({"order": [[ 4, "desc" ]], dom: "<'row'<'col-sm-3'l><'col-sm-5'p><'col-sm-4'f>>" +
	"<'row'<'col-sm-12'tr>>", searching: false, paging: false, lengthMenu: false, aoColumns: [  null,null,null,null,null,null,null,null,null,null ], language: {"search":"", "searchPlaceholder":"Search"} });
	});
	</script>
<?php
}
