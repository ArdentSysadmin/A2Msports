...
<input type='hidden' name='ref_brackets' id='ref_brackets' value='<?php echo $get_bracket['Ref_Brackets']; ?>' />
<input type='hidden' name='esc_players' id='esc_players' value='<?php echo $get_bracket['Esc_Per_Group']; ?>' />
<input type='hidden' name='tour_id' id='tour_id'	 value="<?php echo $get_bracket['Tourn_ID']; ?>" />
...
//alert(club_baseurl);
			...
			$('#showdraw').html(res);
				//$('#showdraw').hide();
				//$('#se_new_draw').html(res);   // section exists in view_drawsresults.php 
				//$('#se_new_draw').show();
				//alert(res);
				//var str2 = "Updated";
				//if(res.indexOf(str2) != -1){
