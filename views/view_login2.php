...
if($req_uri != 'register'){
	$login		 = logintest::get_fb_login();
	$authUrl = logintest::get_google_login();
}
//print_r($login); 
if($login){
?>
...
<a href="#" id="phone_login" class="btn btn-info" role="button" style="margin-bottom: 20px;">
...
<form id="form-phone" class="form-signin" accept="#" style="display:none;">
	...
	<button class="member_login" type="button" id="phoneloginbtn"><i class="fas fa-sign-in-alt"></i> SEND OTP</button>
	</div>
	<div id='otp-input' style="display:none;">
	<input type="otp" id="inputOtp" class="form-control" placeholder="OTP" required="">
	<button class="member_login" type="button" id="verifyotp"><i class="fas fa-sign-in-alt"></i> VERIFY OTP</button>
	</div>
</form>
