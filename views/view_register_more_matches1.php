...
foreach ($reg_events as $key => $value) {
        ...
        <div class="form-group">
           ...
           <label class='control-label padtop' for=""><b>Do you want to change event <?=$event;?> to ?</b></label>
	           <select id='change_event_to' name='change_event_to' class='form-control'>
					<option value=''>Change to?</option>
					<?php
					foreach ($eligible_events as $key2 => $value2) {
