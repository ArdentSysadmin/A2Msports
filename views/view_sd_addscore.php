...
$rr_matches = $sd_bracket_matches->result();
...
if(!in_array($this->logged_user, $players) and !in_array($this->logged_user, $players_partners) and $this->logged_user != $tourn_det->Usersid and $this->logged_user != $tourn_det->Tournament_Director and !$this->is_super_admin)
{
?>
...
<!-- <form method="post" name="form-wff" action="<?php echo base_url();?>league/view_matches"> -->
 ...
 <div class='form-group'>
	<div class='col-md-3 form-group internal'>
	  ...
	  <input class='form-control' value="SD_WFF" name="score_type" type='hidden'> 
...
$(function() {
 ...
 $('#sdate'+spid).datepick();
	...
	<input type='checkbox' name="<?php echo $rr_matches[$m]->Tourn_match_id; ?>" id='wff_add' class='wff_score' />&nbsp;Declare winner by Win by Forfeit
	 ...
	 <input class='form-control' value="SD_ADDSCORE" name="score_type" type='hidden'> 
...
<div class='form-group'>
	...
	<div class='col-md-8 form-group internal scoretable-web'>
	 ...
	 <input class='form-control' value="SD_EDITSCORE" name="score_type" type='hidden'> 
	 <input class='form-control' value="<?php echo $rr_matches[$m]->Player1;?>" id="player1_user" name="player1_user" type='hidden'>
