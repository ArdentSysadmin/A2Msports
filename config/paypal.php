 ...
 *
 */
$config['APIUsername']  = $config['Sandbox'] ? 'admin-facilitator_api1.a2msports.com' : 'admin_api1.a2msports.com';
$config['APIPassword']  = $config['Sandbox'] ? 'RLXDY3SQ6PNT5US6' : '728KLXR5QWS9URBW';
$config['APISignature'] = $config['Sandbox'] ? 'AUfrWDBqps6FD.3kRn7w3-gsTcgqAGUChQUeydN3z550rOSXitwuqYWs' : 'ADfSJQMOTfIywNttfIXyG-eEEiNwAdDynxyQeY.Pg.mMmpioaCUsSEuZ';
